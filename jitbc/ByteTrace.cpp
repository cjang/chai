...
ByteTrace::ByteTrace(VectorTrace& vt)
    : _vt(vt)
{
...
VectorTrace& ByteTrace::getVectorTrace(void)
{
    return _vt;
}

uint64_t ByteTrace::hashCode(void) const
{
    return _vt.hashCode();
}

size_t ByteTrace::numTraces(void) const
{
